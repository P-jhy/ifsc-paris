    ...
    <main className="min-h-screen bg-white text-gray-900">
      <div className="max-w-2xl mx-auto px-6 py-12">
        ...
        {classement.length === 0 ? (
          <div className="border border-gray-100 rounded-2xl p-10 text-center">
            ...
            <p className="text-gray-300 text-sm mt-2">
              Les scores apparaîtront après la première étape.
            </p>
          </div>
        ) : (
          <>
                ...
                >
                  ...
                  <p
                    className={`text-lg font-bold mt-2 ${
                      idx === 0 ? "text-amber-600" : "text-gray-700"
                    }`}
                  >
                    {j.total} pts
                  </p>
            ...
            <div className="border border-gray-100 rounded-2xl overflow-hidden mb-8">
              <div className="grid grid-cols-[32px_1fr_60px] gap-2 px-5 py-3 bg-gray-50 border-b border-gray-100">
                ...
                <p className="text-xs font-semibold text-gray-400 text-right">
                  Total
                </p>
              </div>
              {classement.map((j, idx) => (
                <div
                  key={idx}
                  className="grid grid-cols-[32px_1fr_60px] gap-2 px-5 py-4 border-b border-gray-50 last:border-0 items-center hover:bg-gray-50 transition"
                >
                  ...
                  <thead>
                    <tr className="border-b border-gray-100">
                      ...
                      {etapes.map((e) => (
                        <th
                          key={e}
                          className="text-center px-3 py-3 text-xs text-gray-400 font-medium"
                        >
                          {e}
                        </th>
                      ))}
        ...
        <p className="text-center text-xs text-gray-300 mt-8">
          Mis à jour après chaque étape · 6 étapes au total
        </p>
      </div>
    </main>
  );
